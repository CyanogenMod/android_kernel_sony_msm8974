 ...
 *
 * $Id: linux_osl.c 548460 2015-04-13 08:55:51Z $
 */
...
#ifdef CUSTOMER_HW5
			/* The SKB static buffer ID is defined as latest id of dhd_prealloc_index
			 * + 1 in dhd.h
			 */
			skb_buff_ptr = wifi_platform_prealloc(adapter, 14, 0);
#else
